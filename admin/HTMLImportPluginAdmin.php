 ...
 * functionality, then refer to `class-html-import.php`
 *
 *
 * @package HTMLImportPluginAdmin
 * @author  Patrick Mauro <patrick@mauro.ca>
...
class HTMLImportPluginAdmin {
	...
	private function __construct() {
		 ...
		 *
		 */
		$plugin            = HTMLImportPlugin::get_instance();
	...
	public function enqueue_admin_styles() {
		...
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			wp_enqueue_style( $this->plugin_slug . '-admin-styles', plugins_url( 'assets/css/admin.css', __FILE__ ), array(), HTMLImportPlugin::VERSION );
		}
