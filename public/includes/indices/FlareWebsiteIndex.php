...
class FlareWebsiteIndex extends WebsiteIndex {
	 ...
	 *
	 * TODO: Note, limitations: the index files are named Toc.js and Toc_Chunk#.js.  If the Toc.js defines a different chunk name, it will not work.  Also, it is limited only to a single chunk, so Toc_Chunk0.js.
	 *
